  ...
  return (
    <div
      className={cn(
        ...
        glow
          ? "shadow-[0_2px_10px_rgba(0,0,0,0.05),0_16px_36px_rgba(0,0,0,0.06)] ring-1 ring-brand/15 [.theme-dark_&]:shadow-[0_0_40px_var(--accent-glow)] [.theme-dark_&]:ring-brand-soft/20"
