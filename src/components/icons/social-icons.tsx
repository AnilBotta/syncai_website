/**
 * Brand glyphs as inline SVGs, single-colour via currentColor.
 *
 * Hand-rolled because lucide-react dropped its brand icons in v1 — the same
 * reason WhatsAppIcon exists. Keep the 24x24 viewBox so they line up with the
 * lucide icons used alongside them.
 */
