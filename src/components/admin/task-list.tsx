    ...
    <div>
      <div className="grid gap-2 sm:grid-cols-[1fr_auto_auto]">
        ...
        <input
          ...
          className="h-11 rounded-full border border-sidebar-border px-4 text-sm text-muted outline-none focus:border-brand-soft focus:ring-4 focus:ring-brand/25"
          aria-label="Due date"
        />
        <button
          type="button"
        ...
        {loading ? (
          ...
          tasks.map((task) => {
            ...
            return (
              <div
                key={task.id}
                className="flex items-center gap-3 rounded-2xl border border-sidebar-border p-3"
              >
                <button
                  type="button"
