      ...
      <main id="main" className="bg-bg-base text-foreground">
        <section className="relative overflow-hidden bg-bg-deep px-4 pt-28 pb-20 sm:px-6 sm:py-32 lg:px-8">
          ...
          <Reveal className="relative mx-auto max-w-5xl">
            <Link
              href="/demos"
              className="mb-8 inline-flex items-center gap-2 text-sm font-semibold text-brand transition hover:text-brand-deep"
            >
              <ArrowLeft className="size-4" />
              Back to Demos
            </Link>
            <p className="text-sm font-black uppercase tracking-[.25em] text-brand">{tagline}</p>
